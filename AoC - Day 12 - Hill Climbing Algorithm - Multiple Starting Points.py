...
allStartingPoints = [startingPoint] + symbol_finder(maze, "a")
...
for startPoint in allStartingPoints:
    shortestPathLength = min(shortestPathLength, shortest_path(maze, startPoint, finishPoint))
